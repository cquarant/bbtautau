...
def get_columns(
    ...
    if legacy_taggers:
        columns_data += [
            ...
            ("ak8FatJetCAmass_merged", 3),

            ("ak8FatJetCAmass_subjets_mt", 3),
            ("ak8FatJetCAmass_boostedtaus_mt", 3),
            ("ak8FatJetCAmass_subjets_et", 3),
            ("ak8FatJetCAmass_boostedtaus_et", 3),
            ("ak8FatJetCAmass_subjets", 3),
            ("ak8FatJetCAmass_boostedtaus", 3),
        ]
